...
public class StringPoolLab {
    ...
    public static void main(String[] args) {
        ...
        // Прогноз: false. Причина: два разных объекта в куче (new создаёт новые объекты)
        System.out.println("s3 == s4      : " + (s3 == s4));
        System.out.println("s3.equals(s4) : " + s3.equals(s4));
        System.out.println();

        // Прогноз: true. Причина: intern() возвращает ссылку из пула, где лежит s1
        System.out.println("s1 == s5      : " + (s1 == s5));
        System.out.println("s1.equals(s5) : " + s1.equals(s5));
        System.out.println();

        // Прогноз: true. Причина: "Hel"+"lo" вычисляется компилятором как "Hello" из пула
        ...
        // Прогноз: false. Причина: StringBuilder создаёт строку в куче, а не в пуле
